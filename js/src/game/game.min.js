...
ig.baked=true;ig.module('game.main').requires('impact.game','impact.font').defines(function(){var MyGame=ig.Game.extend({font:new ig.Font('resources/font/04b03.font.png'),init:function(){},update:function(){this.parent();},draw:function(){this.parent();var x=ig.system.width/2,y=ig.system.height/2;this.font.draw('It Works!',x,y,ig.Font.ALIGN.CENTER);}});});})