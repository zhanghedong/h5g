 ...
 */
define("src/app/index-debug", [ "../game/game.min-debug", "zepto-debug" ], function(require, exports, module) {
...
define("src/game/game.min-debug", [], function(require, exports, module) {
    ...
    // engine/impact/impact/loader.js
    ig.baked = true;
    ig.module("impact.loader").requires("impact.image", "impact.font", "impact.sound").defines(function() {
        ...
        ig.Loader = ig.Class.extend({
            ...
            draw: function() {
                ...
                var h = ig.system.height * .1;
                var x = ig.system.width * .5 - w / 2;
                var y = ig.system.height * .5 - h / 2;
    ...
    // engine/impact/impact/impact.js
    ig.baked = true;
    ...
    // engine/impact/impact/animation.js
    ig.baked = true;
    ...
    // engine/impact/impact/entity.js
    ig.baked = true;
    ...
    // engine/impact/impact/collision-map.js
    ig.baked = true;
            ...
            _checkTileDef: function(res, t, x, y, vx, vy, width, height, tileX, tileY) {
                ...
                if (lvx * ty - lvy * tx > 0) {
                    ...
                    if (px * px + py * py >= vx * vx + vy * vy) {
                        return solid || lvx * (ty - vy) - lvy * (tx - vx) < .5;
                    }
                    res.pos.x = x + vx - px;
                    res.pos.y = y + vy - py;
                    res.collision.slope = {
    ...
    // engine/impact/impact/background-map.js
    ig.baked = true;
